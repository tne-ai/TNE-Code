...
- **Alternative:** Experienced contributors can engage directly via [GitHub Projects](https://github.com/orgs/tne-ai/projects/1).
...
- **Check existing issues**: Search [GitHub Issues](https://github.com/tne-ai/TNE-Code/issues).
...
- Check the [GitHub Project](https://github.com/orgs/tne-ai/projects/1) for unassigned "Good First Issues."
- For docs, visit [Compass Docs](https://github.com/tne-ai/TNE-Code-Docs).

### Reporting Bugs

- Check for existing reports first.
- Create new bugs using the ["Bug Report" template](https://github.com/tne-ai/TNE-Code/issues/new/choose).
- **Security issues**: Report privately via [security advisories](https://github.com/tne-ai/TNE-Code/security/advisories/new).
