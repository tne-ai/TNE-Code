...
if [[ "$(uname -s)" != "Darwin" ]]; then
  ...
  echo "See https://github.com/tne-ai/TNE-Code/blob/main/packages/evals/README.md for instructions."
  exit 1
fi
...
if ! code --list-extensions 2>/dev/null | grep -q "tne-ai.tne-code"; then
  code --install-extension tne-ai.tne-code &>/dev/null || exit 1
fi
...
if [[ ! -d "../../../evals" ]]; then
  ...
  git clone https://github.com/tne-ai/TNE-Code-Evals.git ../../../evals || exit 1
  echo "✅ Done"
else
