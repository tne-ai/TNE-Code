...
- **Exercises Repository**: [`TNE-Code-Evals`](https://github.com/tne-ai/TNE-Code-Evals) - Contains all exercise definitions
...
TL;DR - Here's a pull request that adds a new JavaScript eval: https://github.com/tne-ai/TNE-Code-Evals/pull/3
...
1. **Clone the evals repository**:
    ...
    ```bash
    git clone https://github.com/tne-ai/TNE-Code-Evals.git evals
    cd evals
    ```
